  ...
  <section class="rounded-lg border border-[#eee6da] bg-white shadow-sm">
    <div class="flex items-center gap-3 border-b border-[#f1e8dc] px-3 py-2.5 sm:px-4">
      ...
      <div class="flex min-w-0 flex-1 gap-2 overflow-x-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <Link
          ...
          :href="lane.href"
          class="shrink-0 rounded-full border px-3 py-1.5 text-[0.72rem] font-black transition active:scale-95"
    ...
    <div class="grid gap-2 p-3 sm:grid-cols-3 sm:p-4">
      <Link
        ...
        class="rounded-md bg-[#f6efe4] px-4 py-3 transition hover:bg-[#fff4df] active:scale-[0.99]"
      >
      ...
      <Link
        ...
        class="rounded-md bg-slate-950 px-4 py-3 text-white transition hover:bg-slate-800 active:scale-[0.99]"
      >
      ...
      <Link
        :href="season.href"
        class="rounded-md bg-white px-4 py-3 ring-1 ring-[#eee6da] transition hover:bg-[#faf7f2] active:scale-[0.99]"
      >

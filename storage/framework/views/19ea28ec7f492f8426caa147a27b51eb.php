<div class="fi-page">
    ...
    <div class="fi-page-content space-y-6 px-6 pb-8">
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->getToken()): ?>
                <?php
                    $token = $this->getToken();
                    $isExpired = $token->isExpired();
                    $canRefresh = $token->canRefresh();
                ?>
                <div class="rounded-md <?php if($isExpired): ?> bg-red-50 dark:bg-red-900/20 <?php else: ?> bg-green-50 dark:bg-green-900/20 <?php endif; ?> p-4">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm <?php if($isExpired): ?> text-red-800 dark:text-red-200 <?php else: ?> text-green-800 dark:text-green-200 <?php endif; ?>">
                            ...
                            <p class="mt-2 text-xs text-gray-600 dark:text-gray-400">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($token->expires_at): ?>
                                    Expires: <?php echo e($token->expires_at->format('Y-m-d H:i:s')); ?> (<?php echo e($token->expires_at->diffForHumans()); ?>)
                                <?php else: ?>
                                    Expiration time: Not set
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canRefresh && $isExpired): ?>
                        ...
                        <div class="flex gap-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isExpired): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canRefresh): ?>
                                    <button
        ...
        <!-- Import Options -->
        <?php if($this->getToken() && !$this->getToken()->isExpired()): ?>
        ...
        <?php elseif($this->getToken() && $this->getToken()->isExpired()): ?>
...
<?php /**PATH E:\laragon\www\dropshipping\resources\views/filament/pages/aliexpress-import.blade.php ENDPATH**/ ?>